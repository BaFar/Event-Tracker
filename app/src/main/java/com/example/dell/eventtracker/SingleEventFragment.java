...
public class SingleEventFragment extends Fragment implements View.OnClickListener {
   ...
   private AlertDialog.Builder eventEditBuilder;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nearByBtn = (Button) v.findViewById(R.id.near_byBtn);
        weatherBtn = (Button) v.findViewById(R.id.weathrBtn);
        ...
        expenseBuilder.setView(dview)
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Toast.makeText(getContext(), ""+purpose+" "+amount, Toast.LENGTH_SHORT).show();
                        eventInterface.itemExpenseAdd(eventKey,eventPosition,purpose,Integer.parseInt(amount),ExtraHelper.getCurrentTime());/*code 1 is expense*/
                        purposeET.setText("");
                        amountET.setText("");
                    }
                })
    ...
    private void createEditEvent() {
        LayoutInflater inflater = getActivity().getLayoutInflater();
        final View view = inflater.inflate(R.layout.edit_event_basic_info,null);

        final EditText destinationET = (EditText) view.findViewById(R.id.change_destinationET);
